...
export const handler = async (event) => {
    ...
    try {
        ...
        const token = jwt.sign({ userUUID: user.adminUUID, userName: user.userName }, JWT_SECRET, { expiresIn: '1h' });

        return {
            statusCode: 200,
            headers: {
                'Set-Cookie': `token=${token}; HttpOnly; Path=/; Max-Age=3600; SameSite=None; Secure`,
